...
def forward_energy(im):
    ...
    # energy=cv2.imread(r"G:\retarget article\ArtRoom\ArtRoom_saliency.png")
    # energy = cv2.cvtColor(energy, cv2.COLOR_RGB2GRAY)
    # print(energy.shape)
    # energy= Image.open(r"G:\retarget article\ArtRoom\ArtRoom_saliency.png")
    # print(energy.size)
    return energy
...
def main_seam_carve(image, new_height, new_width):
    # IM_PATH = input_path
