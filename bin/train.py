...
def main(config: OmegaConf):
    try:
        ...
        # state = torch.load(r"E:\pytorch-code\lama-main-modify - retarget\best.ckpt", map_location="cpu")
        # training_model.load_state_dict(state['state_dict'], strict=False)
        # training_model.on_load_checkpoint(state)
